...
-- Tiempo de generación: 26-03-2025 a las 16:38:52
...
(1, 'hola', 'bhgjj'),
(2, 'Siembre', 'Regar maiz para siembra'),
(3, 'Siembre', 'Regar maiz para siembra'),
(4, 'Siembre', 'Regar maiz para siembra');
...
(1, '2025-03-03', '\"Luna llena, ideal para cosecha\"', NULL);
...
(1, '2025-03-19', '\"Aplicación de pesticida contra plagas en cultivos de maíz.\"', NULL);
...
(1, '2025-03-08', 'Tomate', '\"Cultivo de tomate en etapa de crecimiento, con seguimiento fitosanitario y control de riego.\"', NULL, NULL);
...
(1, '\"Fertilizante NPK 15-15-15\"', '\"Fertilizante\"', 25000, 50, '\"ml\"');
...
(1, 'aprendiz', '2025-03-07'),
(2, 'pasante', '2025-03-24');
...
(123456789, 'Carlos', 'clave123', 'correo@gmail.com', 1),
(1117806673, 'Yanira', 'clave12345', 'yanira@gmail.com', 1);
...
--
ALTER TABLE `cultivo`
  MODIFY `id_cultivo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
